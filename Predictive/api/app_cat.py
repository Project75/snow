...
json_file = open('../model/2/model_cat.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
keras_model_loaded = model_from_json(loaded_model_json)
keras_model_loaded.load_weights('../model/2/model_cat.h5')
print('Model loaded...')


#load tokenizer pickle file
with open('../model/2/tokenizer_cat.pickle', 'rb') as handle:
    tok = pickle.load(handle)
with open('../model/2/le_cat.pickle', 'rb') as handle2:
...
@app.route('/servicenow/incidentcategory',methods=['POST'])
